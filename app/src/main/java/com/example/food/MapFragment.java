                ...
                .addOnSuccessListener(loc -> {
                    if (loc != null) {
                        ...
                        fusedLocationClient.getLastLocation()
                                ...
                                .addOnFailureListener(e -> Toast.makeText(requireContext(), "Location error", Toast.LENGTH_SHORT).show());
                    }
                })
                .addOnFailureListener(e -> Toast.makeText(requireContext(), "Location error", Toast.LENGTH_SHORT).show());
    }
        ...
        fusedLocationClient.requestLocationUpdates(req, new LocationCallback() {
            ...
            public void onLocationResult(@NonNull LocationResult locationResult) {
                ...
                if (loc != null) {
                    ...
                    Toast.makeText(requireContext(), "定位不可用，暂时居中墨尔本。若用模拟器，请在侧边栏设置位置。", Toast.LENGTH_LONG).show();
                }
            }
            ...
            try {
                ...
                do {
                    ...
                    if (!"OK".equals(status) && !"ZERO_RESULTS".equals(status)) {
                        ...
                        requireActivity().runOnUiThread(() -> Toast.makeText(requireContext(), "Places: " + err, Toast.LENGTH_LONG).show());
                    }
                ...
                requireActivity().runOnUiThread(() -> Toast.makeText(requireContext(), "Nearby search failed", Toast.LENGTH_SHORT).show());
            } finally {
                isFetching = false;
            }
        }).start();
